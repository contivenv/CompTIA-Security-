...
Não tem como falar de tranferência de arquivos sem falar do protocolo FTP. E pra melhorar, o protocolo HTTP tem suporte a vários tipos de mecanismos de downloads e uploads de arquivos. Um deles você já sabe qual é. o FTP ainda continua sendo aopção mais popular ainda por sua facilidade e suporte disponível a ele, por mais que tenhamos outras opções ainda. A maioria dos servidores HTTP funcionam como servidores FTP . Existem duas derivações dele mais seguras e que são recomendadas hoje em dia que são a SFTP que seria a versão de trasnferência de arquivos via link seguro e a FTPS que negocia túnel SSL/TLS antes da troca de arquivos. Ambos resolvem problemas de privacidade da versão original dele.
...
- **STARTTLS**: é um comando que atualiza uma conexão não segura existente para utilizar TLS. Também é denominado TLS explícito ou TLS oportunista.
- **SMTPS**: estabelece uma conexão segura antes que quaisquer comandos SMTP (HELO, por exemplo) sejam trocados. Ele também é denominado TLS implícito.
